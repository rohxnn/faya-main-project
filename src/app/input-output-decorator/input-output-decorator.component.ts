...
export class InputOutputDecoratorComponent {
  ...
  // ];
  list_of_customers:any= [
    {i: 1,name: 'John Smith',address: '',gender:'Male',dob:'12-11-1997',course:'mba',marks:520,percentage:'',fees:1899},
    {i: 2,name: 'Mark Vought',address: '',gender:'Male',dob:'12-11-1997',course:'b.tech',marks:420,percentage:'',fees:2899},
    {i: 3,name: 'Sarah King',address: '',gender:'Female',dob:'12-11-1997',course:'b.tech',marks:540,percentage:'',fees:2899},
    {i: 4,name: 'Merry Jane',address: '',gender:'Female',dob:'12-11-1997',course:'mba',marks:380,percentage:'',fees:1899},
    {i: 5,name: 'Steve Smith',address: '',gender:'Male',dob:'12-11-1997',course:'m.sc',marks:430,percentage:'',fees:799},
    {i: 6,name: 'Jonas Weber',address: '',gender:'Male',dob:'12-11-1997',course:'m.sc',marks:320,percentage:'',fees:799},
  ];
  customer_details = {};
  onEdit(customer: any) {
